...
规范：[https://html.spec.whatwg.org/multipage/forms.html](https://html.spec.whatwg.org/multipage/forms.html).
...
当我们有了一个表单时，其中的任何元素都可以通过命名的集合 `form.elements` 来获取到：![[Pasted image 20260622103604.png]]
...
这是一张示意图：![[Pasted image 20260622104648.png]]
