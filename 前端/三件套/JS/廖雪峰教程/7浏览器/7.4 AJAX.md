...
在现代浏览器上写AJAX主要依靠`XMLHttpRequest`对象，如果不考虑早期浏览器的兼容性问题，现代浏览器还提供了原生支持的Fetch API，以[Promise](https://liaoxuefeng.com/books/javascript/browser/promise/index.html)方式提供。
### 安全限制
